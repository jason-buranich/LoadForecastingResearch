...
# ==============================================================================
class EarlyStopping:
    def __init__(self, patience=15, min_delta=0, model_save_path='best_24hr_patchtst.pth'):
...
# 2. TRAINING LOOP
# ==============================================================================
def train_patchtst(model, train_loader, val_loader, epochs=100, lr=1e-3, weight_decay=1e-4, patience=15, model_save_path='best_24hr_patchtst.pth'):
...
def main():
    ...
    model = PatchTST(
        ...
        seq_len=SEQ_LEN,
        patch_len=8,   # cleanly divides 96
        horizon=HORIZON,
        hidden_dim=128, 
        nheads=4,       
        num_layers=3,   
    ...
    print("\n--- 24-Hour-Ahead PatchTST Metrics (kW) ---")
