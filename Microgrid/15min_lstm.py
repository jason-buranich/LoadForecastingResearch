...
# ==============================================================================
class EarlyStopping:
    def __init__(self, patience=10, min_delta=0, model_save_path='best_15min_direct_lstm.pth'):
...
# 2. TRAINING LOOP
# ==============================================================================
def train_direct_lstm(model, train_loader, val_loader, epochs=100, lr=1e-3, weight_decay=1e-4, patience=10, model_save_path='best_15min_direct_lstm.pth'):
...
def main():
    ...
    print("--- Starting 15-Minute-Ahead Direct LSTM Pipeline ---")
    ...
    model_path = 'best_15min_direct_lstm.pth'
    ...
    print("\n--- 15-Minute-Ahead Direct LSTM Metrics (kW) ---")
    ...
    plot_single_model_forecast(
        ...
        save_path='directlstm_15min_ahead_forecast.png'
    )
