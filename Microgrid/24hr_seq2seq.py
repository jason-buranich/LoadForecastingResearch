...
# ==============================================================================
class EarlyStopping:
    def __init__(self, patience=15, min_delta=0, model_save_path='best_24hr_seq2seq.pth'):
...
# 2. TRAINING LOOP
# ==============================================================================
def train_seq2seq(model, train_loader, val_loader, epochs=100, lr=1e-3, weight_decay=1e-4, patience=15, model_save_path='best_24hr_seq2seq.pth'):
...
def main():
    ...
    print("--- Starting 24-Hour-Ahead Seq2Seq Pipeline ---")
    ...
    # Instantiate Model from models.py using the correct parameter names
    model = Seq2Seq(
    ...
    print("\n--- 24-Hour-Ahead Seq2Seq Metrics (kW) ---")
    ...
    plot_single_model_forecast(
        ...
        start_idx=0, 
        horizon=96,
        model_name="24-Hour Seq2Seq (t+96 step)", 
