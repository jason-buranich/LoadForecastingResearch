...
def main():
    ...
    print(f"--- Starting 15-Minute-Ahead DirectLSTM Pipeline on {device} ---")
    ...
    epochs_no_improve = 0
    best_model_path = 'best_directlstm_15min.pth'
    ...
    print("\n--- 15-Minute-Ahead DirectLSTM Metrics (kW) ---")
