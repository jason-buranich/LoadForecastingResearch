...
def main():
    ...
    print("--- Starting 15-Minute Random Forest Pipeline ---")
    ...
    # Scikit-learn models do not inherently use a validation set for early stopping 
    # (unless doing grid search). Combine Train + Val to maximize the training data.
    ...
    # Flatten the data specifically for tabular models
    ...
    # Instantiate the Random Forest model from models_2.py (mlr, rf, lgbm)
    ...
    preds_flat = rf.predict(X_test_flat)
    ...
    print("\n--- 15-Minute-Ahead Random Forest Metrics (kW) ---")
