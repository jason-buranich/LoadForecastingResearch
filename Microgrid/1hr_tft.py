...
# ==============================================================================
class EarlyStopping:
    def __init__(self, patience=15, min_delta=0, model_save_path='best_1hr_transformer.pth'):
...
class GridTransformer(nn.Module):
    def __init__(self, hist_features, fut_features, seq_len=96, horizon=4, d_model=64, n_heads=4, num_layers=2, dropout=0.1):
        ...
        # Pass the dropout parameter to the TransformerEncoderLayer
...
# 2. TRAINING LOOP
# ==============================================================================
def train_transformer(model, train_loader, val_loader, epochs=100, lr=1e-3, weight_decay=1e-4, patience=10, model_save_path='best_1hr_transformer.pth'):
...
def main():
    ...
    print("--- Starting 1-Hour-Ahead Grid Transformer Pipeline ---")
    ...
    model_path = 'best_1hr_transformer.pth'
    ...
    # Keep the 2D shape (N, 4) for proper metric extraction
