...
def main():
    ...
    print(f"--- Starting 24-Hour-Ahead DirectLSTM Pipeline on {device} ---")
    ...
    epochs_no_improve = 0
    best_model_path = 'best_directlstm_24hr.pth'
    ...
    print("\n--- 24-Hour-Ahead DirectLSTM Metrics (kW) ---")
    ...
    plot_single_model_forecast(
        ...
        start_idx=0, 
        horizon=96,
        model_name="24-Hour DirectLSTM (t+96 step)", 
