...
class EarlyStopping:
    def __init__(self, patience=10, min_delta=0, model_save_path='best_15min_transformer.pth'):
...
def train_transformer(model, train_loader, val_loader, epochs=100, lr=1e-3, patience=10, model_save_path='best_15min_transformer.pth'):
...
def main():
    ...
    print("\n--- 15-Minute-Ahead Grid Transformer Metrics (MW) ---")
