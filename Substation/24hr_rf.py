...
def main():
    ...
    print("--- Starting 24-Hour-Ahead Random Forest (Multi-Model) Pipeline ---")
    ...
    # 4. Initialize and Train the 96 Independent Random Forests
    ...
    multi_rf = MultiOutputRegressor(rf_base, n_jobs=4)
    
    print(f"Training {HORIZON} distinct RF Models on shape {X_train_combined.shape} to predict t+1 through t+{HORIZON}...")
    ...
    print("\n--- 24-Hour-Ahead Random Forest Metrics (MW) ---")
