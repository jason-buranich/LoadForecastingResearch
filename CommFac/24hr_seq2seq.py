...
def main():
    ...
    print(f"--- Starting 24-Hour-Ahead Seq2Seq Pipeline on {device} ---")
    ...
    # NOTE: Adjust these parameters if your Seq2Seq model uses different argument names (e.g., hidden_dim instead of d_model)
    model = Seq2Seq(
    ...
    epochs_no_improve = 0
    best_model_path = 'best_seq2seq_24hr.pth'
