...
def main():
    ...
    print("--- Starting 15-Minute-Ahead Random Forest Predictor ---")
    ...
    preds_kw_flat = inverse_scale(preds)
    targets_kw_flat = inverse_scale(Y_test_np)
