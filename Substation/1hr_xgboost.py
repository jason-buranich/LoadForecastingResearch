...
def main():
    ...
    print("--- Starting 1-Hour-Ahead XGBoost (Multi-Model) Pipeline ---")
    ...
    # 4. Initialize and Train the 4 Independent XGBoost Models
    ...
    multi_xgb = MultiOutputRegressor(xg_base)
    
    print(f"Training 4 distinct XGBoost Models on shape {X_train_combined.shape} to predict t+1 through t+{HORIZON}...")
    ...
    print("\n--- 1-Hour-Ahead XGBoost Metrics (MW) ---")
