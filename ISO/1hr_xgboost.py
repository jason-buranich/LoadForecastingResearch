...
def main():
    ...
    # 4. Initialize and train the single XGBoost model
    print(f"Training XGBoost on shape: {X_train_combined.shape} to predict t+1...")
    ...
    preds_flat = xgb_model.predict(X_test_combined)
    ...
    print("\n--- Hour-Ahead XGBoost Evaluation Metrics (MW) ---")
    ...
    plot_single_model_forecast(
        ...
        preds_mw, 
        start_idx=0, 
        model_name="1-Hour XGBoost", 
        save_path='xgboost_hour_ahead_forecast.png'
    )
