...
class EarlyStopping:
    def __init__(self, patience=10, min_delta=0, model_save_path='best_15min_seq2seq.pth'):
...
def train_seq2seq(model, train_loader, val_loader, epochs=100, lr=1e-3, patience=10, model_save_path='best_15min_seq2seq.pth'):
...
def main():
    ...
    print("--- Starting 15-Minute-Ahead Seq2Seq LSTM Pipeline ---")
    ...
    print("\n--- 15-Minute-Ahead Seq2Seq LSTM Metrics (MW) ---")
    ...
    plot_single_model_forecast(
        ...
        start_idx=0, 
        horizon=96,
        model_name="15-Min Seq2Seq LSTM", 
