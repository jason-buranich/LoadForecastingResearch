...
# Import components from data pipeline
...
def main():
    ...
    # Retain the 2D shape (N, 96) for proper metric extraction
    ...
    print("\n--- 24-Hour-Ahead Direct LSTM Metrics (kW) ---")
    ...
    plot_single_model_forecast(
        ...
        save_path='directlstm_24hr_ahead_forecast.png'
    )
