...
class EarlyStopping:
    def __init__(self, patience=10, min_delta=0, model_save_path='best_1hr_transformer.pth'):
...
def train_transformer(model, train_loader, val_loader, epochs=100, lr=0.000109, weight_decay=0.0009146, patience=10, model_save_path='best_1hr_transformer.pth'):
