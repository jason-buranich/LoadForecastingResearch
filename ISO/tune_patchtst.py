...
print("Generating sequence tensors for PatchTST tuning...")
...
# ==========================================
def objective(trial):
    # Suggest hyperparameters tailored for PatchTST
    ...
    # Ensure hidden_dim is divisible by nheads (required by PyTorch Transformer)
    ...
    # Cap at 15 epochs for fast tuning
...
if __name__ == "__main__":
    ...
    print("\n--- Launching PatchTST Optuna Tuning ---")
