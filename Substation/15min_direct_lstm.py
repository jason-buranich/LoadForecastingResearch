...
def train_direct_lstm(model, train_loader, val_loader, epochs=100, lr=1e-3, patience=10, model_save_path='best_15min_direct_lstm.pth'):
...
def main():
    ...
    print("\n--- 15-Minute-Ahead Direct LSTM Metrics (MW) ---")
