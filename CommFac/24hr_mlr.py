...
def main():
    ...
    print("--- Starting 24-Hour-Ahead MLR Baseline Pipeline ---")
    ...
    print("Fitting Multiple Linear Regression (Ridge) 24-Hour Baseline...")
    ...
    plot_single_model_forecast(
        ...
        start_idx=0, 
        horizon=96,
        model_name="24-Hour MLR Baseline (t+96 step)", 
        save_path='mlr_24hr_ahead_forecast.png'
    )
